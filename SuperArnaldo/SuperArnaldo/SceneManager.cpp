...
void SceneManager::setupScene()
{
	...
	unsigned int texID = loadTexture("../texturas/player_idle.png");
	objects[0]->setTexture(texID);
	texID = loadTexture("../texturas/inimigo_idle.png");
	objects[1]->setTexture(texID);
	texID = loadTexture("../texturas/plataforma01.png");
	objects[2]->setTexture(texID);
	texID = loadTexture("../texturas/fundo01.png");
