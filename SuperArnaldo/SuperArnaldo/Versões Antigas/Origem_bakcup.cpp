...
int main()
{
	...
	unsigned char *data = stbi_load("../texturas/player_idle.png", &largura, &altura, &nCanais, 0);
	
	//data = stbi_load("inimigo_idle.png", &largura, &altura, &nCanais, 1);
	//data = stbi_load("fundo01.png", &largura, &altura, &nCanais, 2);
	//data = stbi_load("plataforma01.png", &largura, &altura, &nCanais, 3);
